export default function handler(req, res) {
  ...
  res.status(200).json([
    ...
    // Support Worker
    {id:'sw-london',            label:'Support Worker in London',        icon:'🤝', group:'Support Worker'},
    ...
    {id:'sw-wales',             label:'Support Worker in Wales',         icon:'🤝', group:'Support Worker'},
    ...
    // Nursing
    {id:'staff-nurse',          label:'Staff Nurse',                     icon:'👩‍⚕️', group:'Nursing'},
    {id:'mental-health-nurse',  label:'Mental Health Nurse',             icon:'🧠', group:'Nursing'},
    {id:'research-nurse',       label:'Research Nurse',                  icon:'🔭', group:'Nursing'},
    // Clinical
    {id:'clinical-fellow',      label:'Clinical Fellow',                 icon:'🩺', group:'Clinical'},
    {id:'clinical-coder',       label:'Clinical Coder',                  icon:'🏷️', group:'Clinical'},
